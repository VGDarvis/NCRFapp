    ...
    <div className="glass-premium p-6 rounded-2xl border border-amber-500/20">
      ...
      <div className="mb-6 p-4 glass-light rounded-xl text-center">
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <span className="text-sm text-muted-foreground">First session starts</span>
        </div>
      ...
      <div className="space-y-3">
        {schedule.map((item, index) => (
          <div 
            key={index}
            className="flex items-start gap-4 p-3 glass-light rounded-lg hover:bg-amber-400/5 transition-colors"
          >
