...
export const CollegeExpoVideo = () => {
  const [isPlaying, setIsPlaying] = useState(false);
  const videoId = 'm0vLbMymHDM';
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold text-foreground mb-4">See What Happens at Black College Expo</h2>
          ...
          {!isPlaying ? (
            ...
            >
              ...
              <img
                ...
                alt="Black College Expo video thumbnail"
            ...
            <iframe
              ...
              title="Black College Expo Video"
